...
jobs_clean |> 
  ...
  coord_flip() +
  scale_y_continuous(labels = label_currency(accuracy = 1, scale = 0.001, suffix = "k"), limits = c(0, 250000)) + # Adjust limits to give space for labels if needed
  labs(y = "Total Earnings")
